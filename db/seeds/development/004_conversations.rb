...
message_from_mark = Message.where(
  user: mark,
  content: "This is the first of many many messages on leada",
  is_draft: false,
  conversation: convo1,
).first_or_create

message_from_tristan = Message.where(
  user: tristan,
  content: "Reply back to mark on the same conversation",
  is_draft: false,
  conversation: convo1,
).first_or_create
...
message_from_mark = Message.where(
  user: mark,
  content: "Messages are the funnest thing on leada i'm so glad they added this feature!",
  is_draft: false,
  conversation: convo2,
).first_or_create

message_from_brian = Message.where(
  user: brian,
  content: "Yo dawg I heard you are the shit",
  is_draft: false,
  conversation: convo2,
).first_or_create
