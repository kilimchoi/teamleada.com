...
welcome_lesson_steps = [
  "Create a model which will predict whether a passenger survived using only the Train data set",
  "Predict whether the passengers survived in the Test data set based on the model we created",
]
